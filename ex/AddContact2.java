...
public class AddContact2 extends MouseAdapter implements ActionListener {
    ...
    // Made Contact class static to fix the inner class issue
    static class Contact {
        ...
        // Fixed toString() to include both name and number
        public String toString() {
            return Name + " - " + Ct_No;
        }
    }
    
    // Added main method to start the application
    public static void main(String[] args) {
        AddContact2 app = new AddContact2();
        app.addComponentToView();
        app.addComponentToAdd();
    }
    ...
    //Collection Initialization - now works with static Contact class
    ...
    public void addComponentToAdd() {
        ...
        jf_AddContact.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    public void addComponentToView() {
        ...
        jf_ViewContact.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        if (e.getSource() == jl_contact) {
            ...
            if (e.getClickCount() == 2) {
                ...
                if (o != null) {
                    ...
                    JOptionPane.showMessageDialog(jf_ViewContact, info, "Contact Details", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        }
    }
